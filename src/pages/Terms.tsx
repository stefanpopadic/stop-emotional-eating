      ...
      <main className="flex-grow py-16 px-6">
        <div className="max-w-3xl mx-auto font-sans text-soft-black space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p>Digital products purchased through this website (guides, trackers, and related resources) are delivered electronically and accessed online via a password-protected reader. All products come with a 30-day money-back guarantee — email us within 30 days of purchase for a full refund, no questions asked.</p>
          </section>
