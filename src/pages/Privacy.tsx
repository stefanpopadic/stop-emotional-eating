    ...
    <div className="min-h-screen bg-warm-linen flex flex-col">
      ...
      <main className="flex-grow py-16 px-6">
        <div className="max-w-3xl mx-auto font-sans text-soft-black space-y-8">
          <h1 className="font-serif font-semibold text-4xl text-deep-sage">Privacy Policy</h1>
          <p className="text-sm text-sand">Last updated: April 2026</p>

          <section className="space-y-4">
            <h2 className="font-semibold text-xl text-deep-sage">What We Collect</h2>
          ...
          <section className="space-y-4">
            <h2 className="font-semibold text-xl text-deep-sage">How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="font-semibold text-xl text-deep-sage">Email Service</h2>
          ...
          <section className="space-y-4">
            <h2 className="font-semibold text-xl text-deep-sage">Cookies & Analytics</h2>
          ...
          <section className="space-y-4">
            <h2 className="font-semibold text-xl text-deep-sage">Unsubscribe</h2>
